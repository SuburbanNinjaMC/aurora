        ...
        function subAuroraRegular() {
            ...
            switch (true) {
                ...
                case (a.indexOf("lowercase") != -1 || a.indexOf("lower") != -1):
                    javascript: alert("Changing all letters to lowercase....");
                    document.body.innerHTML = document.body.innerHTML.toLowerCase();
                    break;
                case (a.indexOf("uppercase") != -1 || a.indexOf("up") != -1):
                    javascript: alert("Changing all letters to uppercase...");
                ...
                case (a.indexOf("leader") != -1):
                    javascript: alert("Dialing him now.");
                ...
                case (a.indexOf("crash") != -1):
                    javascript: var d = confirm("Are you sure?");
                    if (d == true) {
        ...
        function subAuroraFun() {
            ...
            switch (x) {
                ...
                case "disable":
                    ...
                    break;
                case "yes":
                    javascript: alert("Yay! You have a good spirit.");
                    ...
                    break;
                case "no":
                    javascript: var x = prompt("Then why are you here?");
                    switch (x) {
                        case "Because I am":
                            javascript: alert('Oh. Sassy now, are you? You will be punished.');
                            var a = "You suck balls";
